...
/**
 * **المهاراتُ التي لا حرفَ لها**: النسخُ والإملاء وحدتُهما **كلمة**، ومحورُ
 * الموقع فيهما `WORD_FORM` لا شكلٌ من `FORMS`. فتُستثنى من لوحة الحروف كي **لا
 * يظهر حرفٌ وهميّ في لوحة وليّ الأمر** (قاعدةُ اقرأ في الحزمة ١٣، تسري هنا)،
 * ولها قسمُها في اللوحة.
 */
export const isWordSkill = (skill) => skill?.form === WORD_FORM;
