...
/**
 * **نصٌّ للعين بلا حركات** — «لا تُعرَض ولا تُطلَب» (أمرُ المالك، ١٩ أغسطس ٢٠٢٦).
 *
 * **وعلّتُه**: مادّتُنا مشكولةٌ في مصدرها (وهو صوابٌ يبقى — منه ينطق الصوتُ ويقرأ
 * القارئُ الآليّ)، **والطفلُ في هذه المرحلة يكتب بلا شكل**. فما بلغ عينَه يُجرَّد،
 * **و`aria-label` يبقى مشكولاً** فينطقه القارئُ صحيحاً — عرضٌ يُجرَّد لا بيانٌ يُمحى.
 *
 * والمجرَّدُ حركاتٌ وتنوينٌ وشدّةٌ وسكونٌ وألفٌ خنجرية (`U+064B–U+0652` و`U+0670`)
 * — **ولا يُمَسّ حرفٌ**: الهمزةُ والمدّةُ والتاءُ المربوطة حروفٌ لا حركات.
 */
export const bare = (text) => String(text ?? '').replace(/[ً-ْٰ]/g, '');
