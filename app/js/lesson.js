...
export function renderNode(node) {
  ...
  function mount() {
    ...
    // **العرضُ التلقائيّ في «شاهِدْ» وحدَها** (بلاغُ المالك، ٢٣ أغسطس ٢٠٢٦: «كلَّ
    // مرةٍ تتوقّع أن المكان متاحٌ للكتابة تكتشف أنه يعيد يُظهر لك كيف تكتب») —
    // خطواتُ الكتابة تُفتح حيّةً والقلمُ بيد الطفل من أول لمسة: المرجعُ الخافت
    // ووميضُ البداية إرشادُ اللوح لا عرضُه، والإعادةُ بزرّ «شَاهِدْ» عند الطلب.
