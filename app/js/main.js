...
//
// **ويُطفأ بـ`&log=0`** (بلاغُ ميدان قياس الرفض الكاذب، ١٧ أغسطس ٢٠٢٦): لوحُه يشغل
// ربعَ شاشة الآيباد فيزاحم **لوحَ الكتابة** في جلسة قياسٍ طويلة — وعدّةُ تشخيصٍ
// تعمي عن المقيس ليست عدّة. فبقي افتراضُه كما كان (`?dev=1` وحدها تُشغّله لمن
// يشخّص نقرةً)، **وللقائس مفتاحُ إطفاء** لا يمسّ شيئاً سواه.
if (DEV && new URLSearchParams(location.search).get('log') !== '0') probe.mount();
