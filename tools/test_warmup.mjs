...
const nodes = progress.allNodes().filter((n) => n.type === 'warmup');
...
ok(/surface\.play\(\)/.test(code),
  'والعرضُ المتحرك يبدأ من نفسه — «شاهِد» قبل أن يُطلَب، فيُفهَم المطلوبُ بلا شرح');
