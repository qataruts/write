...
/**
 * ✅ **دَينُ ش/نهائي أُغلق في مراجعة ن٢** (٢١ أغسطس ٢٠٢٦): نصفُ قطر الدمج صار يُقرأ
 * **من فجوة نقاط المرجع نفسِه** (`SHAPE_DOTS.gapShare` — «الحدُّ من مالكه») بعد أن كان
 * من السماحة وحدَها فيبتلع الثلاثَ نقطتين. **والمجموعةُ تبقى فارغةً آليّةً حاضرة**:
 * يومَ يظهر دَينُ شكلٍ جديد يدخلها باسمه ويحمرّ سقفُها، ولا يخضرّ من فراغ.
 * (نصُّ الدَّين القديم للتاريخ): **ش/نهائي**
