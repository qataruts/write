...
### ١ب. وجهُ الليل — ⏳ معروضٌ — والحكمُ منتظَر
...
**أصغرُ رفعةٍ تبلغ AA** على ورقنا الليليّ. **وهو مطبَّقٌ في اللوح منذ هـ١ وعينُ
المالك لم ترَه** — فهذه لقطاتُه:
...
**والمطلوب سطرٌ واحد**: إن رضيت عينُك وجهَ الليل فالحكمُ `مُقَرّ`؛ وإن رأيتَ فيه
ما يُصلَح فالإصلاحُ في القاعدة لا في لونٍ يُكتب بيد (`--guide` مثلاً، §٥ من لوحة اللون).

<!-- ⇩ يُحفَظ عند إعادة التوليد — بابُ المالك: الليل ⇩ -->
**الحكم**: (منتظَر)
<!-- ⇧ ينتهي المحفوظ: الليل ⇧ -->

## ٢. الأيقونة — ⏳ معروضٌ — والحكمُ منتظَر
...
**وما تُريه اللقطة**: اللونُ فرّق بالفعل — نِيليٌّ بين برتقاليٍّ وفيروزيّ، وهو ثمرةُ
هـ١. **والرسمُ لم يفترق بعدُ**: أيقونتُنا اليومَ وأيقونةُ اقرأ **بخطٍّ واحد**
(Marhey)، فالفارقُ بينهما لونٌ وحدَه — وذلك عينُ ما رفضه الميثاق. فالبابُ الثاني
**معلَّقٌ على الرابع**: يومَ يُحكَم لخطٍّ تُعاد الأيقوناتُ الأربع به.

**وما تُريه اللقطةُ بالعين**: حبرُ الرقعة أرفعُ وأصغرُ في علبته، فيضعف في
المقاس الصغير (٧٦) حيث تُرى الأيقونةُ في مجلدٍ أو حافظة — وذلك بابُ الدَّين
نفسِه أدناه، فالمقاسُ مضبوطٌ لحبر خطٍّ آخر:

**ودَينٌ يُعلَن قبل التنفيذ — مقاسُ الكلمة في العلبة**: نسبتُه في `icon.html`
رقمٌ ضُبط لـMarhey (٠٫٣٧)، فقُيس حبرُ كلِّ مرشَّحٍ في علبته:

| الخط | عرضُ حبر الكلمة | عرضُ العلبة | ما خرج عنها |
|---|---|---|---|
| Aref Ruqaa | 80.77px | 152px | لا شيء |
| Amiri | 112.66px | 152px | لا شيء |

(ومن خرج حبرُه قُصَّت علامتُه — يُعالَج يومَ التنفيذ بأن يُقاس المقاسُ بحبر
الكلمة نفسِها لا برقمٍ ضُبط لخطٍّ بعينه، وهو دَينٌ أدّاه احسب في جلسته.)

<!-- ⇩ يُحفَظ عند إعادة التوليد — بابُ المالك: الأيقونة ⇩ -->
**الحكم**: (منتظَر)
<!-- ⇧ ينتهي المحفوظ: الأيقونة ⇧ -->

## ٣. الاستعارةُ البطلة — ⏳ معروضٌ — والحكمُ منتظَر
...
- **معالمُ اقرأ (النائبُ اليوم)** — ما ورثته البذرة: بيتُ الحروف وجسرُ المهارات وقبةُ القرآنية وسلّمُ الجمل ومكتبتُها — **وهي بساتينُ أخينا**، تُعرَض هنا عموداً مقابلاً لا مرشَّحاً.
...
<table><tr>
<td align="center" width="33%"><a href="identity/doors/world-marks-now.png"><img src="identity/doors/world-marks-now.png" width="260" alt="معالمُ اقرأ (النائبُ اليوم)"></a><br><sub>معالمُ اقرأ (النائبُ اليوم)</sub></td>
...
- **كما هي — «المجموعة الأولى»** — وارثُ ترتيب اقرأ: مجموعاتُ حروفه السبع بأرقامها. **لا عالمَ فيها ولا حروف** — الطفلُ يقرأ رقماً ويقرأ تحته سطرَ حروفٍ صغيراً.
...
<table><tr>
<td align="center" width="33%"><a href="identity/doors/world-names-now.png"><img src="identity/doors/world-names-now.png" width="260" alt="كما هي — «المجموعة الأولى»"></a><br><sub>كما هي — «المجموعة الأولى»</sub></td>
...
- **كما هي — أيقونةُ قلمٍ محايدة** — الميداليةُ اليومَ `icon('pen')` — **وهو وجهُ عقدة التهيئة نفسُه** الذي تعلنه `nodeFace`، فالحالُ اليومَ صحيحةٌ لا خاطئة. وإنما تظهر الحاجةُ يومَ تُبنى محطاتُ الحروف (الجلسة ٥): يومَها يصير قلمٌ واحد وجهاً لثمانيةٍ وعشرين حرفاً.
...
<table><tr>
<td align="center" width="33%"><a href="identity/doors/world-celebrate-now.png"><img src="identity/doors/world-celebrate-now.png" width="260" alt="كما هي — أيقونةُ قلمٍ محايدة"></a><br><sub>كما هي — أيقونةُ قلمٍ محايدة</sub></td>
...
## ٤. العلامة — ⏳ معروضٌ — والحكمُ منتظَر

«لكل تطبيقٍ رسمُ علامته وخطُّها قرارَ مراجعةٍ يُقَرّ — **وخطُّ Marhey لعلامة اقرأ
وحدَها فلا يُورَّث بالنسخ**» (`FAMILY §٩.٤`). وعلامتُنا اليومَ بخطّه، فهو **نائبٌ
مؤقت معلَن** لا قرارَ لوحٍ اتُّخذ.
...
**ودَينُ التنفيذ معلَنٌ ومعدود**: اسمُ خطّ العلامة مكتوبٌ بيدٍ في
**١١** موضعاً في الشجرة — منها حرّاسٌ يصيرون
يحرسون خطّاً مهجوراً ويمرّون خضراً إن نُسوا:

`app/css/app.css:٥٢` · `app/css/app.css:٥٣` · `app/css/app.css:١١٠` · `app/css/app.css:٥٥٦` · `app/sw.js:٦٠` · `tools/browser_test.html:١٤٧` · `tools/cdn_check.py:١٣٥` · `tools/icon.html:١٥` · `tools/icon.html:١٦` · `tools/icon.html:٢٧` · `tools/icon.html:٥٨`

فيومَ يحكم المالك: يُجلَب الخطُّ إلى `app/fonts/`، ويُبدَّل `--font-brand` وقاعدةُ
`.brand` (وهي اليومَ تكتب الاسمَ بيدها لا تقرأ الرمز)، وتُعاد الأيقوناتُ الأربع،
**ويُسقَط ملفُّ النائب من الشجرة ومن قشرة `sw`** (رفعةُ نسخة) — ويحرس ذلك كلَّه
`test_identity.mjs` (§٥): لا حِملَ لخطّ أخينا في شجرتنا بعد الحكم.
...
> قبل الحكم رسمٌ يُعاد. فيُفتَح بعد حكم الخطّ، ومعه صفحاتُ الترحيب (الجلسة ١١).
...
| وجهُ الليل | ⏳ معروضٌ — والحكمُ منتظَر — مشتقٌّ ومطبَّق، ولقطاتُه معروضة | — |
| الأيقونة | ⏳ معروضٌ — والحكمُ منتظَر — امتحانُ الصفّ لقطةً | — |
| الاستعارة | ⏳ معروضٌ — والحكمُ منتظَر — ثلاثةُ أبوابٍ مصيَّرة | — |
| العلامة | ⏳ معروضٌ — والحكمُ منتظَر — ٢ خطوطٍ مصيَّرة ومقيسة من ٢٨ جُرِّبت | — |
