...
| **اكتب اليوم** | <code>#3F4C8F</code> **لونُ اقرأ نفسُه** | <code>#DAD8FF</code> | <code>#DFAE3F</code> |
...
- «حِبْرٌ نِيليّ» عند ٢٩٢° — سعةُ نطاقه **11.2**، وأقربُ أخٍ إليه calc.accent-quantity على **15.8**
- «أُرْجُوانُ الحِبْر» عند ٣١٦° — سعةُ نطاقه **13.7**، وأقربُ أخٍ إليه read.accent-skills على **14.7**
...
غير أنّ الفاحص ردّه بثلاثة أرقام: `accent-garden` **8.6** عن النموذج المرسوم (والأرضيةُ 27.5) — فحبرُ الطفل لا يفارق نموذجَه على اللوح، وهو أوّلُ ما يجب أن يراه · و`accent-stories` على **13.3** من `--locked` — فمحطةٌ مفتوحةٌ تُقرأ مقفلة · وتمايزُ مراحله **7.7**. فلم يُعرَض، وقيدُه في `tools/palettes.json` ليُقاس لا ليُروى.
...
**واختار المالكُ «زُرْقَةَ الكُرّاسة»** — أوضحَ الثلاثة: ورقٌ `#DAD8FF` يبعد عن ورق
اقرأ **21.83** وعن ورق احسب **19.34** (وعتبتاه ٦ و٤)، ومعه يَدكَن الحبرُ إلى
`#2E2212` فيبقى تباينُ الطفل **11.26:١** فوق تباين اليوم، وفصلُ حبره عن نموذجه
**28.40** فوق فصل اليوم.
